  ...
  return (
    <section className="py-20 md:py-32">
      ...
      <div className="mt-20 md:mt-32">
        <h3 className="text-3xl font-bold text-center mb-4 text-zinc-100">Non-Tech Related</h3>
            ...
            <div>
              ...
              >
                <div className={`relative w-full h-full min-h-[300px] transition-transform duration-700 [transform-style:preserve-3d] ${isExplorerCardFlipped ? '[transform:rotateY(180deg)]' : ''}`}>
                    ...
                    <div 
                      className="absolute w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)] rounded-lg shadow-lg bg-zinc-800 p-6 flex flex-col justify-center items-center text-center"
                      style={cardBackStyle}
                    >
                      <p className="text-zinc-300">Passionate about immersing myself in different cultures, I've lived and worked in Europe, Asia and different states in the U.S., gaining a broad perspective on work ethics and lifestyles.</p>
                    </div>
                </div>
              </div>
              ...
              >
                <div className={`relative w-full h-full min-h-[300px] transition-transform duration-700 [transform-style:preserve-3d] ${isMountainCardFlipped ? '[transform:rotateY(180deg)]' : ''}`}>
                    ...
                    <div
                      ...
                      style={cardBackStyle}
                    >
                      <p className="text-zinc-300">Whether it's hiking a challenging trail or finding a quiet spot to reflect, the mountains are my source of inspiration and rejuvenation.</p>
                    </div>
                </div>
              </div>
              <p className="text-center text-xs text-zinc-500 mt-2 italic">Click card to flip</p>
              ...
              >
                <div className={`relative w-full h-full min-h-[300px] transition-transform duration-700 [transform-style:preserve-3d] ${isRunnerCardFlipped ? '[transform:rotateY(180deg)]' : ''}`}>
                    ...
                    <div
                      ...
                      style={cardBackStyle}
                    >
                      <p className="text-zinc-300">Running teaches me discipline, a practice that sharpens my focus and determination.</p>
                    </div>
                </div>
              </div>
              <p className="text-center text-xs text-zinc-500 mt-2 italic">Click card to flip</p>
