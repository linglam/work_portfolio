...
const Contact: React.FC = () => {
  return (
    <section className="py-20 md:py-32 text-center">
      <h2 className="text-4xl font-bold mb-4 text-zinc-100">Get In Touch</h2>
      ...
      <a
        ...
        className="inline-flex items-center justify-center bg-zinc-900 p-5 rounded-full hover:bg-zinc-800 hover:ring-4 hover:ring-sky-500/30 transition-all duration-300 shadow-lg"
      >
