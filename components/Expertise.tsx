...
const Expertise: React.FC<ExpertiseProps> = ({ selectedSkill, onSkillSelect }) => {
    return (
        <section id="expertise" className="py-20 md:py-32">
            <h2 className="text-4xl font-bold text-center mb-4 text-slate-100">Areas of Expertise</h2>
            <p className="text-sky-400 text-center font-medium">Core competencies and skills</p>
            <p className="text-slate-500 text-center mt-2 mb-12">Click a skill to see it in action in my experience below.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {expertiseAreas.map((area) => (
                    <div key={area.title} className="bg-slate-800 p-6 rounded-lg shadow-lg flex flex-col">
